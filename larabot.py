...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    auto_replies = {
        ...
        # ⬇️ الـ 35 خانة الفاضية جاهزة تحت بعض لـ تعديلك ⬇️
    ...
    # الفحص: لو الكلمة في اللستة الثابتة، رد واقفل
    ...
    try:
        ...
        print(f"حدث خطأ في الاتصال بـ Groq: {e}")
        await update.message.reply_text("عذراً، حصلت مشكلة في السيرفر، جرب أرسل تاني بعد شوية!")

# 4. تشغيل وتدوير البوت
if __name__ == '__main__':
    print("البوت بدأ الشغل بنجاح على منصة Groq.. 🚀")
